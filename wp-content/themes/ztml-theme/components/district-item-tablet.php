...
function render_district_item_tablet($title, $image_src, $is_active = false, $slug)
{
...
?>
	<div class="district-item <?php echo $is_active == true ? 'active' : ''; ?> ">
		<div>
			...
			<div class="content">
				...
				<div class="district-news">
					...
					<?php render_news_template_line($timeline_news_posts[1]->ID); ?>
				</div>
