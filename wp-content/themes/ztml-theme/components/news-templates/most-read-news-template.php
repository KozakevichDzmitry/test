...
function render_most_read_news_template($is_minimazed = false, $type_adv = "page", $id = false)
{
	...
	<?php if ($is_minimazed) : ?>
		<?php $most_read_attached_posts = get_attached_news('2', 'novosti-mira'); ?>
		<?php $most_read_posts = get_default_news('2', 'novosti-mira', $most_read_attached_posts['ids']); ?>

		<div class="box-column-gap most-read-news" style="margin-bottom: 30px;">
			<div class="box-line-gap">
				<div class="box">
					<?php render_new_template_image($most_read_attached_posts['posts'][0]->ID); ?>
				</div>
				<div class="box box-list">
					<?php render_news_template_line($most_read_posts[0]->ID, false, true); ?>
					<?php render_news_template_line($most_read_posts[1]->ID, false, true); ?>
				</div>
			</div>
			<div class="box">
				<?php render_news_template_line($most_read_attached_posts['posts'][1]->ID, true, true); ?>
			</div>
		</div>
	<?php else : ?>
		<?php $most_read_attached_posts = get_attached_news('4', 'novosti-mira'); ?>
		<?php $most_read_posts = get_default_news('4', 'novosti-mira', $most_read_attached_posts['ids']); ?>
		...
		<div class="box-column-gap most-read-news" style="margin-bottom: 30px;">
			...
			<div class="box">
				<?php render_news_template_line($most_read_attached_posts['posts'][1]->ID, true, false); ?>
			</div>
			<div class="box-line-reverse-gap">
				<div class="box">
					<?php render_new_template_image($most_read_attached_posts['posts'][2]->ID); ?>
				</div>
				<div class="box box-list">
					<?php render_news_template_line($most_read_posts[2]->ID, false, true); ?>
					<?php render_news_template_line($most_read_posts[3]->ID, false, true); ?>
				</div>
			</div>
			<div class="box">
				<?php render_news_template_line($most_read_attached_posts['posts'][3]->ID, true, true); ?>
			</div>
		</div>
	<?php endif; ?>
<?php
