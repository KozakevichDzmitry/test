...
function render_world_news_template()
{
?>
	<?php render_topic_bar("Новости мира", true, array(
		'link' => get_site_url() . '/category/novosti-mira/',
	...
	<?php $world_news_attached_posts = get_attached_news('2', 'novosti-mira'); ?>
	<?php $world_news_posts = get_default_news('2', 'novosti-mira', $world_news_attached_posts['ids']); ?>

	<div class="box-column-gap world-news novosti-mira" style="margin-bottom: 30px;">
		<div class="box">
			<?php render_news_template_line($world_news_attached_posts['posts'][0]->ID, true, false); ?>
		</div>
		<div class="box-line-reverse-gap">
			<div class="box">
				<?php render_new_template_image($world_news_attached_posts['posts'][1]->ID); ?>
			</div>
			<div class="box box-list">
				<?php render_news_template_line($world_news_posts[0]->ID, false, true); ?>
				<?php render_news_template_line($world_news_posts[1]->ID, false, true); ?>
			</div>
		</div>
	</div>
<?php
